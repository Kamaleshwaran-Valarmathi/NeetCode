...
// You have a weapon that, once fully charged, can eliminate a single monster. However, the 
// weapon takes one minute to charge. The weapon is fully charged at the very start.
